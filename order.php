...
?>
  ...
  <?php
        if(isset($_POST['submit'])){
            ...
            if($res2==true){
                $_SESSION['order'] = "<div style='color: green;' class='text-center'>Food ordered successfully.</div>";
                header('location:'.SITEURL);
            } else {
                $_SESSION['order'] = "<div style='color: red;' class='text-center'>Failed to order food.</div>";
                header('location:'.SITEURL);
            }
        }
  ?>
